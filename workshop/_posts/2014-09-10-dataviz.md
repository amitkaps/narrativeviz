...
- Overview and introduction to select tools for data visualization: [Excel](http://office.microsoft.com/en-in/excel/) | [Tableau](http://www.tableausoftware.com/public/) | [R - ggplot2](http://ggplot2.org/) | [d3.js](http://d3js.org/) | [Processing](http://www.processing.org/)
